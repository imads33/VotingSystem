...
$voterResult = mysqli_query($conn, "SELECT * FROM `voters` 
    WHERE `v_adhhar`='$uaadhar' AND `eType`='Central Election'");
...
<body>
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div>
                <p id="button-th">Central Elections</p>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <?php
                    $candidates = "SELECT * FROM `candidates` WHERE `eType`='Central Election'";
