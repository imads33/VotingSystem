...
$voterResult = mysqli_query($conn, "SELECT * FROM `voters` 
    WHERE `v_adhhar`='$uaadhar' AND `eType`='Taluk Panchayat Election'");
...
<head>
    ...
    <title>Taluk Panchayat Election</title>
</head>
...
<body>
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div>
                <p id="button-th">Taluk Panchayat Elections</p>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                if ($voted) {
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Sorry!</strong> You have voted for <strong>Taluk Panchayat Election</strong>
                ...
                <div class="row">
                    <?php
                    $candidates = "SELECT * FROM `candidates` WHERE `eType`='Taluk Panchayat Election'";
